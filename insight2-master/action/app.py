...
class AppAdd(LoginedRequestHandler):
    ...
    def post(self):
        ...
        group_owner = self.get_argument('group_owner', '')
        ...
        doc = dict(appname = appname, apptype = apptype, \
                ...
                op_user_id = group_owner ) # add by wuq  复用op_user_id 来存放应用负责人
