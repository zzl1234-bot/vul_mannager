...
# 漏洞状态
VUL_STATUS = {"10": "待审核", "20": "已忽略", "30": "已驳回", "35": "暂不处理", "40": "已确认", "50": "修复中", "55": "复测中", "60": "已完成","65":"复测不通过"}

# 项目状态
PROJECT_STATUS = {"0": "未完成","1":"已完成"}
...
# 漏洞来源
#mod by wuq
VUL_SOURCE = {"10": "安恒", "20":"国舜", "30": "绿盟", "40":"公众渠道", "50": "其他"}
...
#mod by wuq
APP_STATUS = {"10": "生产环境", "20": "生产灰度", "30": "测试环境"}
