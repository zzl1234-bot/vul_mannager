    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                meta: { title: "Vulns" ,noKeepAlive: true}
            },
            {
                path: '/vulnlog',
                name: 'vulnlog',
            ...
            },
            {
                path: '/project_app',
                name: 'project_app',
                component: resolve => require(['../components/page/project/Project_app.vue'], resolve),
                meta: { title: "Project_app" }
            },
             {
                path: '/ProAppDetail',
                name: 'ProAppDetail',
                component: resolve => require(['../components/page/project/ProAppDetail.vue'], resolve),
                meta: { title: "ProAppDetail" }
            },
            {
                path: '/doc',
                name: 'doc',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: '/n_my_projects',
                name: 'n_my_projects',
                component: resolve => require(['../components/page/personal/MyProjects.vue'], resolve),
                meta: { title: "MyProjects", noKeepAlive: true }
            },
            ...
            {
                path: '/n_viewprojectdetail',
                name: 'n_viewprojectdetail',
                component: resolve => require(['../components/page/personal/subpage/ViewProjectDetail.vue'], resolve),
                meta: { title: "ViewProjectDetail", noKeepAlive: true }
            },
            {
                path: '/n_viewproappdetail',
                name: 'n_viewproappdetail',
                component: resolve => require(['../components/page/personal/subpage/ViewProAppDetail.vue'], resolve),
                meta: { title: "ViewProAppDetail", noKeepAlive: true }
            },
            {
                path: '/n_notification',
                component: resolve => require(['../components/page/Notification.vue'], resolve)
