    ...
    <div class="container">
      <div class="handle-box">
        ...
        <div style="float:right">
          ...
          >无可用的操作</span>
          <el-button size="mini" type="primary" @click="updateCur_entity();solveVisible=true;cur_audit_status='/auditing/refix' "  v-show="isShowSubmitRetestButton">复测不通过</el-button>
          <el-button size="mini" type="primary" @click="updateCur_entity();solveVisible=true;cur_audit_status='/auditing/fixed' "  v-show="isShowSubmitRetestButton">复测通过</el-button>
...
",
  ...
  computed: {
    ...
    isShowNoOp:function(){
      return !this.isShowText && !this.isShowConfirmButton &&  !this.isShowApplyRetestButton && !this.isShowSubmitRetestButton
    },
