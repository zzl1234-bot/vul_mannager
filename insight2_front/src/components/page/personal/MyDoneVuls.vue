  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>已完成漏洞</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <div style="float:right">
          ...
          <el-button
            ...
            @click="updateCur_entity();auditVisible=true;"
          >审核</el-button>
          <el-button
            size="mini"
            type="primary"
      ...
      >
        ...
        <el-table-column
          ...
          label="类型"
          min-width="100"
          :filters="[{ text: '弱口令', value: '10' }, { text: 'SQL注入漏洞', value: '120' }]"
          :filter-method="filterVulType"
...
",
      ...
      cur_entity: {},
      add_url: "/api/vul/add",
      list_url: "/api/vul/my/list?vul_status=1",
      del_url: "/api/vul/del",
  ...
  computed: {
    ...
    risklevel: function() {
      if (this.form.self_rank >= 0 && this.form.self_rank < 6) {
        ...
        return "高危";
      } else if (this.form.scolortypeelf_rank <= 20) {
        return "严重";
      }
    },
  ...
  methods: {
   exportDocument(t){
    ...
    getStatusGroup() {
      this.$axios.get("api/vul/my/status/group?vul_status=1").then(res => {
