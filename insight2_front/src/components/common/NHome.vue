      ...
      <div style="  float: left; height:50px;">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="n_my_projects">我的项目 ({{my_projects_count?my_projects_count:"0"}})</el-menu-item>
          </el-submenu>
          <!-- del by wuq
  ...
  methods: {
    ...
    getUserInfo() {
      ...
      this.$axios.get(this.user_info_url, {}).then(res => {
        ...
        this.my_projects_count = res.data.my_projects_count;
